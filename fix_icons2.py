...
text = text.replace('Icons.Default.ArrowBack', 'Icons.Filled.ArrowBack')
text = text.replace('Icons.Default.ArrowForward', 'Icons.Filled.ArrowForward')
text = text.replace('Icons.Default.OpenInNew', 'Icons.Filled.OpenInNew')
